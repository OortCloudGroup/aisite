...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      title: '数据赋能平台-面向数据智能场景 奥尔特云数据赋能平台',
      link: [
        { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico?v=4' }
      ],
      meta: [
        { name: 'viewport', content: 'width=device-width, initial-scale=1' },
        { property: 'og:title', content: '数据赋能平台-面向数据智能场景 奥尔特云数据赋能平台' },
        ...
        { name: 'keywords', content: '数据赋能平台-面向数据智能场景 奥尔特云数据赋能平台，奥陌陌，警务宝，一体化智慧基层平台，治安宝，奥尔特云，公共安全，移动办公，私有化部署，天琴智慧，午托管理，人脸识别考勤，托管人脸识别考勤，移动警务，智慧警务，即时通讯服务，安全加密通讯，实时音视频服务，私有化部署的移动安全办公云平台，微服务架构，分层解耦，共享服务，去烟囱，去竖井' }
      ],
      script: [
